 ...
 * @returns
 */
function getAlphar(epsilon, ta, ts) {
 ...
 * @returns
 */
function getAlphac(w, d1, ta = 0, ts = 0) {
    if (w == 0) {
 ...
 * @returns
 */
function getAlphas(alphar, alphac) {
 ...
 * @returns
 */
function getLambda(tm, lambda0 = 0.044) {
 ...
 */
function getT0(t_A, h_A, p_B, ta, d0, d1, epsilon, w, f, l) {
