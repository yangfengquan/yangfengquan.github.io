...
public:
    FluidDialog(const QString& fluid = QString(), QWidget *parent = nullptr);
    QString getFluidString();
...
private:
    ...
    void populateSelectedComponentTable(const QString& fluid);

    const QMap<QString, QString> fluidMap = {
        // 基础气体
        {"Air", "空气"},
        {"Nitrogen", "氮气"},
        {"Oxygen", "氧气"},
